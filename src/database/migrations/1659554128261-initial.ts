...
export class initial1659554128261 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`swab_area_history_image\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`swab_area_history_image_description\` text NULL, \`swab_area_history_id\` varchar(36) NOT NULL, \`file_id\` varchar(36) NOT NULL, UNIQUE INDEX \`REL_439991ba4e96d7868a5b9466a8\` (\`file_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`bacteria\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`bacteria_name\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_09395fa945bc1f5d567fe4c2b4\` (\`bacteria_name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`bacteria_specie\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`bacteria_specie_name\` varchar(255) NOT NULL, \`bacteria_id\` varchar(36) NOT NULL, UNIQUE INDEX \`IDX_74a3d725fad0c47562fb48ccf6\` (\`bacteria_specie_name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`swab_area_history\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`swab_area_date\` date NOT NULL, \`swab_area_swabed_at\` time NOT NULL, \`swab_area_temperature\` decimal(3,1) NULL, \`swab_area_humidity\` decimal(3,1) NULL, \`swab_area_atp\` int NULL, \`swab_area_note\` text NULL, \`swab_period_id\` varchar(36) NOT NULL, \`swab_area_id\` varchar(36) NOT NULL, \`swab_test_id\` bigint NULL, \`shift\` enum ('day', 'night') NULL, \`product_id\` varchar(36) NULL, \`product_date\` date NULL, \`product_lot\` varchar(255) NULL, \`facility_item_id\` varchar(36) NOT NULL, UNIQUE INDEX \`REL_e73987a66b8f766eda9cf7554e\` (\`swab_test_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`swab_product_history\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`product_id\` varchar(36) NOT NULL, \`swab_product_lot\` varchar(255) NOT NULL, \`shift\` enum ('day', 'night') NULL, \`swab_product_date\` date NOT NULL, \`swab_product_swabed_at\` time NULL, \`swab_test_id\` bigint NOT NULL, UNIQUE INDEX \`REL_c62ce25cf55e6a376ee270b101\` (\`swab_test_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`product_schedule\` (\`id\` varchar(36) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`product_schedule_amount\` int NOT NULL, \`product_schedule_date\` date NOT NULL, \`product_schedule_started_at\` time NOT NULL, \`product_schedule_ended_at\` time NOT NULL, \`product_id\` varchar(36) NOT NULL, \`import_transaction_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`swab_test_bacteria_bacteria\` (\`swab_test_id\` bigint NOT NULL, \`bacteria_id\` varchar(36) NOT NULL, INDEX \`IDX_a9c9308ecabb10fe44e2082cfe\` (\`swab_test_id\`), INDEX \`IDX_40b98624fe59d77064f99de906\` (\`bacteria_id\`), PRIMARY KEY (\`swab_test_id\`, \`bacteria_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`swab_test_bacteria_species_bacteria_specie\` (\`swab_test_id\` bigint NOT NULL, \`bacteria_specie_id\` varchar(36) NOT NULL, INDEX \`IDX_3ddd9b2f62985e93eda1fa89bc\` (\`swab_test_id\`), INDEX \`IDX_552d8b5850ffc44b68bdfb4526\` (\`bacteria_specie_id\`), PRIMARY KEY (\`swab_test_id\`, \`bacteria_specie_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`bacteria_specie\` ADD CONSTRAINT \`FK_2f46c3033d3f3ccdfbba2764bd3\` FOREIGN KEY (\`bacteria_id\`) REFERENCES \`bacteria\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_bacteria\` ADD CONSTRAINT \`FK_a9c9308ecabb10fe44e2082cfe7\` FOREIGN KEY (\`swab_test_id\`) REFERENCES \`swab_test\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_bacteria\` ADD CONSTRAINT \`FK_40b98624fe59d77064f99de9068\` FOREIGN KEY (\`bacteria_id\`) REFERENCES \`bacteria\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_species_bacteria_specie\` ADD CONSTRAINT \`FK_3ddd9b2f62985e93eda1fa89bcd\` FOREIGN KEY (\`swab_test_id\`) REFERENCES \`swab_test\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_species_bacteria_specie\` ADD CONSTRAINT \`FK_552d8b5850ffc44b68bdfb45260\` FOREIGN KEY (\`bacteria_specie_id\`) REFERENCES \`bacteria_specie\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_species_bacteria_specie\` DROP FOREIGN KEY \`FK_552d8b5850ffc44b68bdfb45260\``);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_species_bacteria_specie\` DROP FOREIGN KEY \`FK_3ddd9b2f62985e93eda1fa89bcd\``);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_bacteria\` DROP FOREIGN KEY \`FK_40b98624fe59d77064f99de9068\``);
        await queryRunner.query(`ALTER TABLE \`swab_test_bacteria_bacteria\` DROP FOREIGN KEY \`FK_a9c9308ecabb10fe44e2082cfe7\``);
        ...
        await queryRunner.query(`ALTER TABLE \`bacteria_specie\` DROP FOREIGN KEY \`FK_2f46c3033d3f3ccdfbba2764bd3\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_552d8b5850ffc44b68bdfb4526\` ON \`swab_test_bacteria_species_bacteria_specie\``);
        await queryRunner.query(`DROP INDEX \`IDX_3ddd9b2f62985e93eda1fa89bc\` ON \`swab_test_bacteria_species_bacteria_specie\``);
        await queryRunner.query(`DROP TABLE \`swab_test_bacteria_species_bacteria_specie\``);
        await queryRunner.query(`DROP INDEX \`IDX_40b98624fe59d77064f99de906\` ON \`swab_test_bacteria_bacteria\``);
        await queryRunner.query(`DROP INDEX \`IDX_a9c9308ecabb10fe44e2082cfe\` ON \`swab_test_bacteria_bacteria\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_74a3d725fad0c47562fb48ccf6\` ON \`bacteria_specie\``);
        await queryRunner.query(`DROP TABLE \`bacteria_specie\``);
        await queryRunner.query(`DROP INDEX \`IDX_09395fa945bc1f5d567fe4c2b4\` ON \`bacteria\``);
