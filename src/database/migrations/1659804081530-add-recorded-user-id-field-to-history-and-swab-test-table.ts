...
export class addRecordedUserIdFieldToHistoryAndSwabTestTable1659804081530 implements MigrationInterface {
    name = 'addRecordedUserIdFieldToHistoryAndSwabTestTable1659804081530'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`swab_test\` ADD \`swab_test_recorded_at\` timestamp NULL`);
